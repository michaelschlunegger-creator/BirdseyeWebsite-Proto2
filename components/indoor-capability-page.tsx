...
const capabilityContent: Record<string, CapabilityVisual> = {
  "/visual-thermal-imaging/": {
    ...
    image: "/visuals/elios3-official.jpg",
    alt: "Flyability Elios 3 in flight, with its protective cage, front camera and inspection lighting",
    caption: "Elios 3 · Visual and thermal capture with onboard lighting",
  ...
  "/slam/": {
    ...
    title: "Capture\n3D reality.",
    image: "/visuals/elios3-survey-official.png",
    alt: "Official Flyability rendering of the Elios 3 Surveying Payload, showing the LiDAR sensor inside the protective cage",
    caption: "Elios 3 Surveying Payload · Official product rendering",
  ...
  return <main className={styles.page}>
    ...
    <div className={`container ${styles.body}`}>
      ...
      <div className={styles.footnote}>
        ...
        <p>Product imagery and example outputs: <a href={content.source} target="_blank" rel="noreferrer">Flyability</a>.</p>
      </div>
    </div>
  </main>;
}
